...
I’ve been using them a little recently for a few things, including this blog and some [coding](http://http/code/) projects. The problem is, with 1000 icons, finding the ones that are suitable for what you’re doing.
...
In half an hour or so I knocked together a quick demo of (as i’ve now dubbed it) the **[Icon Selector](http://dsingleton.co.uk/code/icon-selector)**. I’m pretty happy with how it turned out, it’s easy to search for and preview the icons you want.

I’ve made a few tweaks since to speed it up a little, you can take a peak at the [Javascript source](http://dsingleton.co.uk/code/icon-selector/icons.js) if you want to see the jQuery magic, it’s pretty cool.
