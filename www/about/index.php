...
<?php require_once '../_inc/header.inc.php'; ?>
    ...
    <div class="l-rcol">
        <div class="primary">
            ...
            <p>I love taking things apart, figuring out how they work, and solving problems. Mostly code or design, but sometimes baking too.</p>
            
            <p>Sometimes I write about these things on my <a href="/blog">blog</a>.</p>
            
            <p>My day job is a web developer at <a href="http://last.fm">Last.fm</a>, a large music social network. I do both front and back end development and have been working with the web for about 10 years now.</p>
            ...
            <h2>Photos</h2>
            <ul id="about-photos" class="inline photos clearfix">
